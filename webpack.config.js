...
const clientEntrypoints = [
  {
    name: 'CLIENT - ActiveCampaign UTM Sync',
    entry: './src/client/active-campaign-utm-sync/index.tsx',
    filename: 'active-campaign-utm-sync',
    template: './src/client/active-campaign-utm-sync/index.html',
  },
];
